            ...
            <div class="container-fluid text-center text-md-left">
                <div class="row text-white">
                    <div class="col-md-2 mx-auto">
                        ...
                        Rembo Vape Store is a website that sells a variety of vape.
                        <br>
                    ...
                    <div class="col-md-2 mx-auto">
                        ...
                        <ul class="list-unstyled">
                            +62 819 034 419 718 <br>
                            Rembovapestore@gmail.com <br>
                            Jl.Ngronggot Kediri, Tanjungtani, Kabupaten Nganjuk, Jawa Timur 64484
                        </ul>
                    </div>
                </div>
            </div>
            <div class="footer-copyright text-center py-3 bg-dark text-white">©2025 Copyright :
                <a href="index.html"> Rembo Vape Store</a>
            </div>
        </div>
    </footer>
