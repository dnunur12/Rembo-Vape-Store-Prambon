    ...
    <div class="container bg-white rounded pt-4 pb-4">
        <div class="row">
            ...
            <div class="col-md-4 col-sm-12 text-left">
                <h5>Contact Info</h5>
                <p>Bagi yang memiliki kendala atau memiliki saran untuk toko kami,kami menyediakan contact untuk dihubungi.Terimakasih</p>
                <i class="fa fa-tty"></i> 0819 0341 9718 <br>
                <i class="fa fa-envelope"></i> Rembovapestore@gmail.com <br>
                <i class="fa fa-hourglass"></i> Monday - Sunday (09.00 - 21.00) <br>
                <i class="fa fa-map-marker"></i> Jl.Ngronggot Kediri, Tanjungtani, Kabupaten Nganjuk, Jawa Timur 64484 <br>
    ...
    <script>
        ...
        function initMap() {
            ...
            var maps = {
                lat: -7.719933765907076,
                lng: 112.02441649436726
            };
